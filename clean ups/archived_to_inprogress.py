...
def convert_to_inprogress(wo_num):
    ...
    sql_insert = f"INSERT INTO EN_COURS (NU_INT,NU_BON_C,NU_IMM,N_UF,N_EF,DA_AP,HE_AP,DA_INT,HE_INT,DA_HS,HE_HS,DA_DIS,HE_DIS,DA_FIN,HE_FIN,URG,DISP_EF_AT,DISP_AP_AT,COMPT," \
                 ...
                 f"FK_PREP_ID,ORDER_AMOUNT,TOT_TTC_PLUS_ORD_AM,CALIBRATION_WO,CALIBRATION_DATE,CALIBRATION_NEXT_DATE,CALIBRATION_WO_STATUS) " \
                 f"SELECT " \
                 f"NU_INT,NU_BON_C,NU_IMM,N_UF,N_EF," \
                 ...
                 f"CALIBRATION_WO_STATUS " \
                 f"FROM B_FT1996 WHERE NU_INT='{wo_num}'\n\n"
