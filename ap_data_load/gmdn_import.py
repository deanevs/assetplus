...
def main():
    ...
    fn = get_excel_file('udi')  # 'ultrasound'
    cols = ['UDI','Brand','Model','Company','Description']
    df = pd.read_csv(fn, delimiter='\t', header= None, names=cols, engine='python')
    # df = df.fillna()
...
def get_excel_file(name):
    ...
    if name == "pulse":
        ...
        fn = "C:\\Users\\212628255\\Box Sync\\AssetPlus UK\\GMDN Datasets\\gmdn_source_data\\UDI_File_2020-02.txt"
    else:
